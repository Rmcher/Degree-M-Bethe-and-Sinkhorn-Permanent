...
% Bethe approximation Permanent in factor graphs
% A is the square matrix, n is the size of A
% permB is the Bethe Approximation of Permenent, V is the message on the full edge of factorgraphs
                    ...
                    for i_prime = 1:n
                        if i_prime ~= i
                            ...
                            for i_double_prime = 1:n
                                if i_double_prime ~= i && i_double_prime ~= i_prime
                    ...
                    for j_prime = 1:n
                        if j_prime ~= j
                            ...
                            for j_double_prime = 1:n
                                if j_double_prime ~= j && j_double_prime ~= j_prime
